...
public class RecentlyViewedAdapter extends RecyclerView.Adapter<RecentlyViewedAdapter.RecentlyViewedViewHolder> {
    ...
    public RecentlyViewedAdapter(Context context, List<plat_restaurant> recentlyViewedList) {
    ...
    public void onBindViewHolder(@NonNull RecentlyViewedViewHolder holder, final int position) {
        ...
        holder.name.setText(recentlyViewedList.get(position).getNom());
        holder.description.setText(recentlyViewedList.get(position).getDescription());
        holder.price.setText(recentlyViewedList.get(position).getPrix());
        holder.qty.setText(recentlyViewedList.get(position).getPrix());
        holder.unit.setText(recentlyViewedList.get(position).getPrix());

        holder.bg.setBackgroundResource(R.drawable.b4);
