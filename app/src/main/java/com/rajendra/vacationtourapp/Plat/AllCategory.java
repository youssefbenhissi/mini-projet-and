...
import com.rajendra.vacationtourapp.adapter.AllCategoryAdapter;
...
String idRestaurant;
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        back.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View view) {
                Intent back = new Intent(AllCategory.this, detailRestaurantNouveauActivity.class);
                back.putExtra("idRestaurant", idRestaurant);
                startActivity(back);
                finish();
            }
        });
    ...
    private void setCategoryRecycler(List<AllCategoryModel> allcategoryModelList) {
        ...
        allCategoryAdapter = new AllCategoryAdapter(this,allcategoryModelList,idRestaurant);
